        ...
        this.#formulario.addEventListener('submit',async (e)=>{
            ...
            if(this.#nombreUsuario.value.trim() === "" ||
                ...
                this.#nick.value.trim() === ""){
                 ...
                 try {
                     const response = await fetch('../../../test/registrarDatos.php', {
                         method: 'POST',
                         body: formData
                     });
                     ...
                     if (data.status === 'ok') {
                         ...
                         window.location.href = '../../html/juego/menuPrincipal.html';
                     } else {
                         this.#aviso.innerText = data.message || "Error al registrar";
                     }
                 } catch (error) {
                     console.error(error);
                     this.#aviso.innerText = "Error de conexión";
                 }
            }

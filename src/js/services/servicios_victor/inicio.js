...
btnIniciarSesión.addEventListener("click", () => {
    window.location.href="../../../html/victor/menuPrincipal.html"; //Para enlazar mediante ruta
});

//Evento cuando pulsamos registrarse
btnRegistrarse.addEventListener("click", () => {
    window.location.href="../../../html/victor/registro.html";
});
...
btnInvitado.addEventListener("click", () => {
    ...
    if(modoAleatorio=="modo1"){
        window.location.href="../../html/victor/preguntas.html";
    }else if(modoAleatorio=="modo2"){
        window.location.href="../../html/victor/situaciones.html";
    }else{
        window.location.href="../../html/victor/fotos.html";
    }
});
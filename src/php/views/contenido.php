            ...
            <?php
                foreach($preguntas as $pregunta) {
                    echo '<div class="datos_de_contenido">
                            ...
                            <button class="borrar"><a href="./index.php?c=borrarPreguntas&m=borrar&id='.$pregunta['idPregunta'].'"><img src="views/css/icon/papelera.png" alt=""></a></button>
                            <button class="configurar"><a href="./index.php?c=modificarPregunta&m=modificar&id='.$pregunta['idPregunta'].'"><img src="views/css/icon/ajustes.png" alt=""></a></button>
                          </div>';
                }   
            ?>
       </div>
            ...
            <?php
                foreach($situaciones as $situacion) {
                    echo '<div class="datos_de_contenido">
                              ...
                              <button class="borrar">
                                 <a href="./index.php?c=borrarSituacion&m=borrar&id='.$situacion['idSituacion'].'"><img src="views/css/icon/papelera.png" alt=""><a>
                              </button>
                              <button class="configurar">
                                 <a href="./index.php?c=modificarSituacion&m=modificar&id='.$situacion['idSituacion'].'">
            ...
            <?php
               foreach($imagenes as $imagen) {
                  echo "<div class='datos_de_contenido div_foto'>
                           <img src=../proyecto/".$imagen['foto']." alt=''>
                           <button class='borrar'>
                                 <a href='./index.php?c=BorrarFotos&m=borrar&id=".$imagen['idFoto']."'>
                                    <img src='views/css/icon/papelera.png' alt=''>
                                 <a>
                           </button>
                           <button class='configurar'>
                                 <a href='./index.php?c=ModificarFotos&m=recogerDatos&id=".$imagen['idFoto']."'>
                                    <img src='views/css/icon/ajustes.png' alt=''>
                                 </a>
                           </button>
                        </div>";

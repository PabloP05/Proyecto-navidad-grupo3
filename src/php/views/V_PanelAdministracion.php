...
<body class="Cpanel_body">
    ...
    <main>
        <form action="./indexAdrian.php?c=C_AñadirContenidos&m=agregarContenido" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit">Subir archivos <img src="../css/icon/subidaDeArchivos.png" alt=""> </button>
        </form>
    </main>
